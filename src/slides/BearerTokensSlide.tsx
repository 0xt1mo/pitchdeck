...
function TokenEmblem() {
  const chips: { label: string; cx: number; cy: number; w: number; from: [number, number]; to: [number, number] }[] = [
    { label: 'SELF-CONTAINED', cx: 230, cy: 46, w: 176, from: [230, 158], to: [230, 63] },
    { label: 'SELF-PROVING', cx: 372, cy: 372, w: 158, from: [286, 300], to: [332, 356] },
    { label: 'PEER-TO-PEER', cx: 88, cy: 372, w: 158, from: [174, 300], to: [128, 356] },
  ];
  return (
    <svg viewBox="0 0 460 460" className="h-auto w-full max-w-[410px]">
      ...
      >
        ...
        <text x="329" y="173" textAnchor="middle" fontFamily={MONO} fontSize="15" fill={ORANGE}>+ PROOF</text>
      </motion.g>
    </svg>
  );
}
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-10 lg:py-12 gap-6 lg:gap-8">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-6 lg:gap-8">
          ...
          <div className="lg:w-[36rem] shrink-0">
            ...
            >
              Bearer <span className="text-orange-400">Tokens.</span>
            </motion.h2>
            ...
            >
              <p className="text-sm sm:text-base text-[#fefefe]/50" style={{ fontFamily: MONO }}>
                <span className="text-[#fefefe]/80">bear·er to·ken</span>
            ...
            >
              ...
              >
                See the protocol <span aria-hidden>→</span>
              </a>
            </motion.div>
