    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-8 lg:py-9 gap-4 lg:gap-5">
        ...
        <div className="shrink-0">
          ...
          >
            Unicity AOS × DDN · The upside, in numbers
          </motion.p>
          <motion.h1
        ...
        >
          <p className="text-orange-400 text-xs lg:text-sm tracking-[0.16em] uppercase shrink-0 leading-snug" style={{ fontFamily: MONO }}>What DDN<br />books</p>
