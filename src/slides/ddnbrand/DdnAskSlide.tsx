...
const phases: Phase[] = [
  {
    ...
    today: true,
    items: [
      <><span className="text-[#fefefe] font-bold">NRE-funded validation</span> of AOS on DDN Infra.</>,
  ...
  },
  {
    ...
    items: [
      <>AOS embedded as the <span className="text-[#fefefe] font-bold">runtime layer of an DDN SKU</span>.</>,
    ],
  },
  {
