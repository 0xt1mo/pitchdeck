    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 sm:px-12 lg:px-16 py-10 lg:py-12 gap-7">
        ...
        <div className="shrink-0">
          ...
          >
            Coding agents are the new attack surface. <span className="text-orange-400 font-bold">Unicity governs them at the kernel</span> — every action bounded, redacted, and proven.
          </motion.p>
        </div>
