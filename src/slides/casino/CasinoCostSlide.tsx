...
// Non-text metadata (stable keys + zero flag) stays outside the translation map.
const itemMeta = [
  { key: 'card', zero: true },
  { key: 'chargebacks', zero: true },
  { key: 'psp', zero: false },
  { key: 'funnel', zero: false },
];

const T = tr({
  en: {
    eyebrow: 'Nº 07 · Cost',
    headLead: 'Agents reduce',
    headAccent: 'payments friction.',
    intro: "Card processing, chargebacks, PSP integrations, deposit funnels — the apparatus that exists to get money into your platform. Agents arrive with the money. They've already KYC'd upstream.",
    items: [
      { name: 'Card Processing', today: '2.5–3.5% of deposit volume', after: '0' },
      { name: 'Chargebacks & Disputes', today: '0.5–1.0% of deposits + per-dispute', after: '0' },
      { name: 'PSP Integration Stack', today: '5+ vendors per geography', after: '1 rail' },
      { name: 'Deposit Funnel', today: '30% abandon at first attempt', after: '0 funnel' },
    ],
    imgAlt: 'Agent topping up the MagicCasino wallet via the concierge',
  },
  pt: {
    eyebrow: 'Nº 07 · Custo',
    headLead: 'Agentes reduzem',
    headAccent: 'o atrito de pagamentos.',
    intro: 'Processamento de cartão, chargebacks, integrações com PSP, funis de depósito — o aparato que existe para colocar dinheiro na sua plataforma. Os agentes chegam com o dinheiro. Eles já passaram pelo KYC a montante.',
    items: [
      { name: 'Processamento de Cartão', today: '2.5–3.5% do volume de depósitos', after: '0' },
      { name: 'Chargebacks & Disputas', today: '0.5–1.0% dos depósitos + por disputa', after: '0' },
      { name: 'Stack de Integração PSP', today: '5+ fornecedores por região', after: '1 trilho' },
      { name: 'Funil de Depósito', today: '30% abandonam na primeira tentativa', after: '0 funil' },
    ],
    imgAlt: 'Agente adicionando saldo à carteira do MagicCasino via concierge',
  },
});
              ...
              >
                ...
                <div
                  ...
                  style={{
                    ...
                    fontSize: m.zero ? undefined : undefined,
                  }}
                >
                  <span className={m.zero ? 'text-[44px] lg:text-[56px]' : 'text-[22px] lg:text-[28px]'}>
                    {it.after}
                  </span>
                </div>
              </motion.div>
