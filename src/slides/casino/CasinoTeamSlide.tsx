...
const founders = [
  {
    ...
    lines: [
      ...
      'Built and exited Guardtime (ADX:IHC)',
      'Former MD, Barclays Capital',
    ],
  },
  {
    name: 'Tony Kenyon',
    ...
    lines: [
      ...
      '25 years shipping AI and enterprise infrastructure',
      ...
      <div className="relative z-10 h-full flex flex-col px-12 lg:px-20 py-6 lg:py-8 justify-center gap-4">
        ...
        <div className="shrink-0">
          ...
          <motion.p
            ...
            style={{ fontFamily: "'Geist Mono', monospace" }}
          >
            <span className="text-[#fefefe] font-semibold">Unicity Labs.</span> A team of PhDs in machine learning and cryptography with deep experience building agent systems — applying fifteen years of nation-state-grade cryptographic engineering to the infrastructure your agents transact on.
          </motion.p>
        </div>
