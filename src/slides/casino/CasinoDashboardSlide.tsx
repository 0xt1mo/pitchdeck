...
const pillars = [
  {
    label: 'Security',
    desc: 'Semantic interception mesh — every payload verified at runtime.',
    img: '/dashboards/security.png',
    accent: '#ef4444',
  },
  {
    label: 'Governance',
    desc: 'Live policy library, approvals, and a complete audit log.',
    img: '/dashboards/governance.png',
    accent: '#22c55e',
  },
  {
    label: 'Networks',
    desc: 'Open channels across A2A, MCP, x402 — counterparty-aware.',
    img: '/dashboards/networking.png',
    accent: '#a855f7',
  },
  {
    label: 'Payments',
    desc: 'Cash flow, settlement balances, and per-agent budgets in real time.',
      ...
      <div className="relative z-10 h-full flex flex-col px-6 sm:px-8 lg:px-10 py-6 sm:py-8 lg:py-10 justify-center gap-4">
        ...
        <div className="shrink-0">
          ...
          <motion.p
            ...
            style={{ fontFamily: "'Geist Mono', monospace" }}
          >
            Identity, delegation, policy, settlement, and audit — unified into a single operator surface. It sits beneath any agent deployment, with no rip-and-replace.
          </motion.p>
        </div>
