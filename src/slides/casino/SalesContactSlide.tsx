...
const T = tr({
  en: {
    ...
    demoBody: 'See an agent open a session, place a wager, settle — end-to-end.',
    address: (
      <>
  ...
  pt: {
    h1Lead: 'VEJA EM',
    h1Accent: 'AÇÃO.',
    demoTitle: 'Agende uma Demonstração ao Vivo',
    demoBody: 'Veja um agente abrir uma sessão, fazer uma aposta e liquidar — de ponta a ponta.',
    address: (
      <>
        <span className="text-[#fefefe] font-bold">Unicity Labs</span>
        <br />
    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      <div className="relative z-10 h-full flex flex-col px-10 lg:px-20 py-12 lg:py-16 justify-center gap-7">
        ...
        <div className="shrink-0">
          ...
          >
            {T.h1Lead} <span className="text-orange-400">{T.h1Accent}</span>
          </motion.h1>
        </div>
