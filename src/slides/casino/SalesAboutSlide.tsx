...
// Names stay identical across languages; role/bio swap.
const team = [
  { name: 'Mike Gault' },
  { name: 'Tony Kenyon' },
  { name: 'Nitish Malik' },
...
const T = tr({
  en: {
    h1Lead: '15 YEARS OF',
    h1Accent: 'CRYPTOGRAPHIC INFRASTRUCTURE.',
    awardCaption: (
      <>
    ...
    team: [
      { role: 'CEO', bio: 'PhD Engineering · Founder Guardtime (ADX:IHC) · MD Barclays Capital' },
      { role: 'Product', bio: 'PhD Machine Learning · Vitruvian · BT · Nokia' },
      { role: 'Senior Advisor', bio: 'Aleria · Etisalat' },
    ],
    proof: [
  ...
  pt: {
    h1Lead: '15 ANOS DE',
    h1Accent: 'INFRAESTRUTURA CRIPTOGRÁFICA.',
    awardCaption: (
      <>
        <span className="text-orange-400 font-bold">World Government Summit, Dubai.</span>{' '}
    ...
    team: [
      { role: 'CEO', bio: 'PhD em Engenharia · Fundador da Guardtime (ADX:IHC) · MD no Barclays Capital' },
      { role: 'Produto', bio: 'PhD em Machine Learning · Vitruvian · BT · Nokia' },
      { role: 'Conselheiro Sênior', bio: 'Aleria · Etisalat' },
    ],
    proof: [
