...
const T = tr({
  en: {
    tagline: 'For Gaming Operators',
    titleLead: 'Agents at the',
    titleAccent: 'front door.',
    subtitle: 'The Secure AI OS for gaming operators.',
    footer: 'Confidential · 2026',
  },
  pt: {
    tagline: 'Para Operadores de Cassino',
    titleLead: 'Agentes na',
    titleAccent: 'porta da frente.',
    subtitle: 'O OS de IA Seguro para operadores de cassino.',
