...
// Crypto-free variant of TractionSlide — the testnet-wallet / testnet-app stats are
// removed for enterprise / regulated audiences. Everything else matches TractionSlide.
    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 sm:px-12 lg:px-20 py-8 lg:py-12 gap-6 lg:gap-9">
        ...
        <motion.div
          ...
          className="shrink-0 grid grid-cols-2 border-y border-[#fefefe]/12"
        >
          {stats.map((s, i) => (
            <div
              key={s.value}
              className={`px-4 lg:px-7 py-5 lg:py-7 ${i % 2 !== 0 ? 'border-l' : ''} border-[#fefefe]/12`}
            >
              <p
