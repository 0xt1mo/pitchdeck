...
const asks: { big: string; label: string; detail: React.ReactNode }[] = [
  ...
  },
  {
    big: 'Product',
    label: 'Partnership',
    detail: <>Co-build and co-sell — <span className="text-[#fefefe] font-bold">Unicity AOS on Alerix infrastructure</span>, one reference architecture, and industry solutions built on top.</>,
  },
];
