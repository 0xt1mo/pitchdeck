...
const T = tr({
  ...
  pt: {
    ...
    sub: (
      <>
        Um OS não é marketing — são <span className="text-orange-400">syscalls, IPC, permissões, cotas, drivers.</span> Todos reivindicam o rótulo; aqui, cada primitiva é uma implementação real. Harnesses de agentes reconstroem a mesma pilha — memória, armazenamento, ferramentas. Um OS oferece um <span className="text-orange-400">kernel extensível com multi-tenancy por design.</span>
      </>
    ),
    cards: [
      { fn: 'Processos', term: 'Capsules', desc: 'Programas WASM selados, isolados por construção — uma tarefa cada.' },
      ...
      { fn: 'Usuários e permissões', term: 'Tokens de capacidade', desc: 'Identidade, grupos, concessões. Mais rígido que o Unix — o poder só se estreita.' },
      ...
      { fn: 'Drivers', term: 'Capsules de provedor', desc: 'Os modelos são os periféricos da era dos agentes. Troque um como um driver; nada acima percebe.' },
    ],
  },
});
