  ...
  return (
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      <div className="relative z-10 h-full flex flex-col px-6 sm:px-10 lg:px-16 py-10 sm:py-14 lg:py-16 justify-center gap-6">
        ...
        {/* Social links */}
        <div className="shrink-0 flex items-center gap-6 pt-4 border-t border-white/[0.08]">
          ...
          <a
            ...
            className="flex items-center gap-2 text-[#fefefe]/85 hover:text-orange-400 transition-colors cursor-pointer"
            style={{ fontFamily: "'Geist Mono', monospace" }}
          >
            <svg viewBox="0 0 24 24" fill="currentColor" className="w-5 h-5">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
            </svg>
            <span className="text-sm sm:text-base">@unicity_labs</span>
          </a>
          <a
          ...
          >
            ...
            <span className="text-sm sm:text-base">unicity-labs</span>
          </a>
        </div>
