...
const POLICY_SVG = `<svg viewBox="0 0 1000 460" width="100%" style="height:auto" xmlns="http://www.w3.org/2000/svg"><defs><marker id="pa" viewBox="0 0 10 10" refX="7" refY="5" markerWidth="6" markerHeight="6" orient="auto"><path d="M2 1L8 5L2 9" fill="none" stroke="#FF8904" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"/></marker><filter id="pg" x="-60%" y="-60%" width="220%" height="220%"><feGaussianBlur stdDeviation="6" result="b"/><feMerge><feMergeNode in="b"/><feMergeNode in="SourceGraphic"/></feMerge></filter></defs><text x="270" y="56" text-anchor="middle" font-family="'Geist Mono',monospace" font-size="15" letter-spacing="2" fill="rgba(254,254,254,0.42)">THE AGENT TRIES TO</text><text x="500" y="50" text-anchor="middle" font-family="'Anton',sans-serif" font-size="20" fill="#FF8904">POLICY ENGINE</text><text x="500" y="70" text-anchor="middle" font-family="'Geist Mono',monospace" font-size="12" fill="rgba(254,254,254,0.42)">checked before the agent acts</text><text x="760" y="56" text-anchor="middle" font-family="'Geist Mono',monospace" font-size="15" letter-spacing="2" fill="rgba(254,254,254,0.42)">THE RESULT</text><line x1="500" y1="88" x2="500" y2="412" stroke="#FF8904" stroke-width="3" filter="url(#pg)"/><text x="452" y="110" text-anchor="end" font-family="'Geist Mono',monospace" font-size="18" fill="#fefefe">Collect a photo</text><line x1="460" y1="104" x2="478" y2="104" stroke="#FF8904" stroke-opacity="0.5" stroke-width="1.4" marker-end="url(#pa)"/><circle cx="500" cy="104" r="13" fill="#FF8904" filter="url(#pg)"/><path d="M495 104 L499 108 L506 99" fill="none" stroke="#0a0a0a" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/><line x1="515" y1="104" x2="700" y2="104" stroke="#FF8904" stroke-width="1.6" marker-end="url(#pa)"/><text x="715" y="110" font-family="'Geist Mono',monospace" font-size="16" fill="#FF8904">stored, with consent</text><text x="452" y="162" text-anchor="end" font-family="'Geist Mono',monospace" font-size="18" fill="#fefefe">Book a slot</text><line x1="460" y1="156" x2="478" y2="156" stroke="#FF8904" stroke-opacity="0.5" stroke-width="1.4" marker-end="url(#pa)"/><circle cx="500" cy="156" r="13" fill="rgba(254,254,254,0.06)" stroke="rgba(254,254,254,0.72)" stroke-width="2"/><rect x="495.5" y="151" width="3" height="10" rx="1" fill="rgba(254,254,254,0.72)"/><rect x="501.5" y="151" width="3" height="10" rx="1" fill="rgba(254,254,254,0.72)"/><line x1="515" y1="156" x2="700" y2="156" stroke="rgba(254,254,254,0.72)" stroke-width="1.4" stroke-dasharray="4 4"/><text x="715" y="162" font-family="'Geist Mono',monospace" font-size="16" fill="rgba(254,254,254,0.72)">only from live Odoo</text><text x="452" y="214" text-anchor="end" font-family="'Geist Mono',monospace" font-size="18" fill="#fefefe">Send a graft price</text><line x1="460" y1="208" x2="478" y2="208" stroke="#FF8904" stroke-opacity="0.5" stroke-width="1.4" marker-end="url(#pa)"/><circle cx="500" cy="208" r="13" fill="rgba(254,254,254,0.06)" stroke="rgba(254,254,254,0.72)" stroke-width="2"/><rect x="495.5" y="203" width="3" height="10" rx="1" fill="rgba(254,254,254,0.72)"/><rect x="501.5" y="203" width="3" height="10" rx="1" fill="rgba(254,254,254,0.72)"/><line x1="515" y1="208" x2="700" y2="208" stroke="rgba(254,254,254,0.72)" stroke-width="1.4" stroke-dasharray="4 4"/><text x="715" y="214" font-family="'Geist Mono',monospace" font-size="16" fill="rgba(254,254,254,0.72)">only after the doctor</text><text x="452" y="266" text-anchor="end" font-family="'Geist Mono',monospace" font-size="18" fill="#fefefe">Store an image</text><line x1="460" y1="260" x2="478" y2="260" stroke="#FF8904" stroke-opacity="0.5" stroke-width="1.4" marker-end="url(#pa)"/><circle cx="500" cy="260" r="13" fill="rgba(254,254,254,0.06)" stroke="rgba(254,254,254,0.72)" stroke-width="2"/><rect x="495.5" y="255" width="3" height="10" rx="1" fill="rgba(254,254,254,0.72)"/><rect x="501.5" y="255" width="3" height="10" rx="1" fill="rgba(254,254,254,0.72)"/><line x1="515" y1="260" x2="700" y2="260" stroke="rgba(254,254,254,0.72)" stroke-width="1.4" stroke-dasharray="4 4"/><text x="715" y="266" font-family="'Geist Mono',monospace" font-size="16" fill="rgba(254,254,254,0.72)">only with consent</text><text x="452" y="318" text-anchor="end" font-family="'Geist Mono',monospace" font-size="18" fill="#fefefe">Escalate a high-risk case</text><line x1="460" y1="312" x2="478" y2="312" stroke="#FF8904" stroke-opacity="0.5" stroke-width="1.4" marker-end="url(#pa)"/><circle cx="500" cy="312" r="13" fill="#FF8904" filter="url(#pg)"/><path d="M495 312 L499 316 L506 307" fill="none" stroke="#0a0a0a" stroke-width="2.2" stroke-linecap="round" stroke-linejoin="round"/><line x1="515" y1="312" x2="700" y2="312" stroke="#FF8904" stroke-width="1.6" marker-end="url(#pa)"/><text x="715" y="318" font-family="'Geist Mono',monospace" font-size="16" fill="#FF8904">routed to a human</text><text x="452" y="370" text-anchor="end" font-family="'Geist Mono',monospace" font-size="18" fill="#fefefe">Issue a diagnosis</text><line x1="460" y1="364" x2="478" y2="364" stroke="#FF8904" stroke-opacity="0.5" stroke-width="1.4" marker-end="url(#pa)"/><circle cx="500" cy="364" r="13" fill="rgba(254,254,254,0.04)" stroke="rgba(254,254,254,0.42)" stroke-width="2"/><path d="M495 359 L505 369 M505 359 L495 369" stroke="rgba(254,254,254,0.42)" stroke-width="2" stroke-linecap="round"/><text x="715" y="370" font-family="'Geist Mono',monospace" font-size="16" fill="rgba(254,254,254,0.42)">never</text></svg>`;
function PolicyGate() { return <div className="dia w-full flex justify-center" style={{ maxHeight: '44vh' }} dangerouslySetInnerHTML={{ __html: POLICY_SVG }} />; }
...
export function PadraPolicySlide() {
  return (
    <Shell>
      ...
      <div className="shrink-0 mt-5 -mx-6 sm:mx-0 overflow-x-auto"><div className="min-w-[680px] sm:min-w-0 mx-6 sm:mx-0"><PolicyGate /></div></div>
