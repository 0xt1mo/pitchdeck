    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col px-8 sm:px-12 lg:px-16 py-8 lg:py-10 gap-6 lg:gap-8">
        ...
        <div className="shrink-0">
          ...
          >
            DEPLOYMENT INSIDE <span className="text-orange-400">ENTERPRISE INFRASTRUCTURE</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
          ...
          >
            ...
            <span className="text-[#fefefe] font-semibold">your data and the request never leave your network.</span>
          </motion.p>
        </div>
            ...
            >
              ...
              {/* Orange bracket routing from SIF out to External LLM, Mobile App,
                  ...
                  760-unit canvas:
                    ...
                    Client App (hosted) top:25%   + h:11%/2 = 30.5% → y=232
