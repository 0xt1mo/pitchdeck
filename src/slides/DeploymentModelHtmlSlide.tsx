    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col px-8 sm:px-12 lg:px-16 py-8 lg:py-10 gap-6 lg:gap-8">
        ...
        <div className="shrink-0">
          ...
          >
            INSIDE A SINGLE <span className="text-orange-400">CLIENT'S BOUNDARY.</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            ...
            style={{ fontFamily: mono }}
          >
            Zoom into one tenant. Every prompt, tool call, and decision passes through one enforcement gate —{' '}
            <span className="text-[#fefefe] font-bold">the client&apos;s data never leaves their network.</span>
          </motion.p>
        </div>
