  ...
  return (
    <g>
      <text x={centerX} y={centerY - 8} textAnchor="middle" dominantBaseline="central"
        fill="#fefefe" fontSize="22" fontFamily="Anton, sans-serif" letterSpacing="0.05em">
        10B
      </text>
      <text x={centerX} y={centerY + 14} textAnchor="middle" dominantBaseline="central"
        fill="rgba(254,254,254,0.5)" fontSize="9" fontFamily="Geist Mono, monospace">
        TOTAL SUPPLY
      </text>
    </g>
  );
    ...
    <ResponsivePie
      ...
      tooltip={({ datum }) => (
        <div style={{
          ...
          borderRadius: '8px', padding: '10px 16px', fontFamily: "'Geist Mono', monospace",
          backdropFilter: 'blur(12px)',
        }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            <div style={{ width: 10, height: 10, borderRadius: '50%', backgroundColor: datum.color, boxShadow: `0 0 8px ${datum.color}` }} />
      ...
      <div className="relative z-10 h-full flex flex-col px-8 sm:px-12 lg:px-20 py-10 sm:py-14 lg:py-16">
        ...
        <div>
          ...
          <motion.h1
            ...
            GENESIS <span className="text-orange-400">TOKEN ALLOCATION</span>
          </motion.h1>
        </div>
          ...
          <div className="flex-1 space-y-3 sm:space-y-4">
            {slices.map((slice, i) => {
              ...
              return (
                <motion.div
                  ...
                  animate={{ opacity: 1, x: 0, scale: isHovered ? 1.03 : 1 }}
                  transition={isHovered ? { scale: { duration: 0.2 } } : { delay: 0.6 + i * 0.1, duration: 0.5 }}
                ...
                >
                  <div className="w-3 h-3 rounded-full shrink-0 transition-all duration-200"
                    style={{ backgroundColor: slice.color, boxShadow: isHovered ? `0 0 12px ${slice.color}` : 'none' }} />
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.8 }}
              ...
              <p className="text-[#fefefe]/40 text-[11px] sm:text-xs tracking-wider"
                style={{ fontFamily: "'Geist Mono', monospace" }}>
                Total Genesis Supply: <span className="text-[#fefefe]/70">10,000,000,000 tokens</span>
              </p>
            </motion.div>
          </div>
        </div>
