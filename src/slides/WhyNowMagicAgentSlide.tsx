...
const capabilities = ['BOOKING', 'MESSAGING', 'TRIAGE', 'FOLLOW-UP', 'AVAILABLE 24/7'];
    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col justify-center px-8 sm:px-12 lg:px-20 py-10 lg:py-14 gap-6 lg:gap-9">
        ...
        <div className="shrink-0">
          ...
          >
            THE MAGIC AGENT <span className="text-orange-400">HAS ARRIVED.</span>
          </motion.h1>
        </div>
        ...
        <motion.p
          ...
          style={{ fontFamily: mono }}
        >
          A swarm of vendors is promising an agent that just handles the work —
          booking, messaging, triage, follow-up, around the clock. It&apos;s a
          genuinely compelling pitch.
        </motion.p>
        ...
        >
          <p
            ...
            style={{ fontFamily: display }}
          >
            BUT THIS WORK TOUCHES{' '}
            <span className="text-orange-400">DATA, RECORDS, AND PATIENTS.</span>
          </p>
        </motion.div>
