    ...
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col px-8 sm:px-12 lg:px-16 py-10 lg:py-12 justify-center gap-6 lg:gap-8">
        ...
        <div className="shrink-0">
          ...
          >
            <span className="text-[#fefefe]">Autonomy breaks</span>{' '}
          ...
          <motion.p
            ...
            style={{ fontFamily: MONO }}
          >
            Every era of compute kept a <span className="text-[#fefefe] font-bold">human in the loop</span> to keep it safe — to log in, approve the action, and stand accountable. Autonomy removes the human. Safety has to be built into the machine.
          </motion.p>
        </div>
        ...
        <motion.p
          ...
          style={{ fontFamily: ANTON }}
        >
          <span className="text-[#fefefe]/70">Autonomous AI is only as safe as it is verifiable —</span>{' '}
          <span className="text-orange-400">so we make it verifiable by construction.</span>
        </motion.p>
