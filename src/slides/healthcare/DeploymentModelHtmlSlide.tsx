...
const T = tr({
  en: {
    eyebrow: 'Deployment',
    headLead: 'RUNS INSIDE',
    headAccent: 'YOUR INFRASTRUCTURE.',
    subhead: (
      <>
    ...
    boxMobileApp: 'Mobile App (hosted)',
    boxExternalAgent: 'External agent',
    gateInterceptTitle: 'Semantic Intercept Fabric',
    gateInterceptSub: 'One gate · single egress · allow / block / flag',
    gateRegistryTitle: 'Agent Registry',
    gateRegistrySub: 'Cryptographic identity · scoped, revocable',
  ...
  pt: {
    eyebrow: 'Implantação',
    headLead: 'RODA DENTRO DA',
    headAccent: 'SUA INFRAESTRUTURA.',
    subhead: (
      <>
        O agente roda dentro da sua rede, atrás de um único portão de saída.{' '}
        <span className="text-[#fefefe] font-bold">Os dados do paciente e o momento clínico nunca saem da sua rede</span>{' '}
        — a resposta para GDPR, soberania e transferência transfronteiriça, tudo de uma vez.
      </>
    ),
    ...
    boxMobileApp: 'App Móvel (hospedado)',
    boxExternalAgent: 'Agente externo',
    gateInterceptTitle: 'Semantic Intercept Fabric',
    gateInterceptSub: 'Um portão · saída única · permitir / bloquear / sinalizar',
    gateRegistryTitle: 'Agent Registry',
    gateRegistrySub: 'Identidade criptográfica · com escopo, revogável',
    aosTitle: 'AOS · Ambiente de Hospedagem',
    aosSub: 'Kernel de aplicação · sandbox WASM · orçamentos',
    agentSandbox: 'Sandbox de Agente',
        ...
        >
          ...
          >
            ...
            <GateBox left="4%" top="24.1%" width="43%" height="10%"
              title={T.gateInterceptTitle}
              subtitle={T.gateInterceptSub} />

            {/* Agent Registry (gate) */}
            <GateBox left="4%" top="38.9%" width="43%" height="9.5%"
              title={T.gateRegistryTitle}
              subtitle={T.gateRegistrySub} />
