...
const T = tr({
  en: {
    ...
    headLead: 'TECHNICAL',
    headAccent: 'APPENDIX.',
    subline: 'AOS Kernel · Why AOS · Swappable Capsules · Semantic Intercept Fabric',
  },
  pt: {
    eyebrow: 'Seção',
    headLead: 'APÊNDICE',
    headAccent: 'TÉCNICO.',
    subline: 'AOS Kernel · Por que AOS · Cápsulas Intercambiáveis · Semantic Intercept Fabric',
  },
});
