...
const T = tr({
  en: {
    eyebrow: 'Use Case · PHI Exfiltration Prevention',
    headLead: 'PHI EXFILTRATION',
    headAccent: 'PREVENTION.',
    intro:
  ...
  pt: {
    eyebrow: 'Caso de Uso · Prevenção de Exfiltração de PHI',
    headLead: 'PREVENÇÃO DE',
    headAccent: 'EXFILTRAÇÃO DE PHI.',
    intro:
      'A Unicity fica diretamente no fluxo de transporte, inspecionando payloads de LLM antes que saiam do perímetro do hospital — para que os dados do paciente não possam ser exfiltrados para um modelo não autorizado.',
    bullets: [
      {
        label: 'REDAÇÃO DE PHI EM LINHA',
        body: 'Detecte e mascare PHI, PII e identificadores no prompt antes que a inferência seja executada.',
      },
      {
        label: 'CANAIS GOVERNADOS',
        body: 'Rotas sancionadas e monitoradas substituem contas pessoais do ChatGPT e ferramentas não gerenciadas.',
      },
      {
        label: 'REGISTROS DE CONFORMIDADE',
        body: 'Registros criptográficos e à prova de adulteração de todos os dados de pacientes acessados por agentes, para auditoria HIPAA/GDPR.',
      },
    ],
  },
});
