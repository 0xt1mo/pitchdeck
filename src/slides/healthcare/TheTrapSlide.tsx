...
const T = tr({
  en: {
    eyebrow: 'The trap',
    headLead: 'THE MOST REGULATED',
    headAccent: 'BEHAVIORS ON EARTH.',
    colAction: 'What the agent does',
    colLegal: 'What it legally is',
    rows: [
    ...
    payoffLead: "The capability you're buying and the liability you're taking on are",
    payoffAccent: 'the same five actions.',
  },
  pt: {
    eyebrow: 'A armadilha',
    headLead: 'OS COMPORTAMENTOS MAIS',
    headAccent: 'REGULADOS DA TERRA.',
    colAction: 'O que o agente faz',
    colLegal: 'O que isso é legalmente',
    rows: [
      { action: 'Armazena uma foto', legal: 'Processamento de PHI e consentimento' },
      { action: 'Cota um preço', legal: 'Regras comerciais e de publicidade' },
      { action: 'Agenda um horário', legal: 'Tratamento de dados do paciente' },
      { action: 'Envia mensagem a um paciente', legal: 'Comunicação e consentimento' },
      { action: 'Deriva para um diagnóstico', legal: 'Exercício da medicina' },
    ],
    payoffLead: 'A capacidade que você está comprando e a responsabilidade que você está assumindo são',
    payoffAccent: 'as mesmas cinco ações.',
  },
});
