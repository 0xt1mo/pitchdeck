...
const T = tr({
  en: {
    eyebrow: 'Get Started',
    headLead: 'SEE AN AGENT HIT A REGULATED BOUNDARY —',
    headAccent: 'AND GET STOPPED.',
    description:
    ...
    hudLeft: 'Unicity · Get Started',
  },
  pt: {
    eyebrow: 'Comece Agora',
    headLead: 'VEJA UM AGENTE ATINGIR UMA FRONTEIRA REGULADA —',
    headAccent: 'E SER BLOQUEADO.',
    description:
      'Veja um agente tentar uma prescrição, uma transferência internacional, um armazenamento sem consentimento — e ser interceptado em trânsito, ao vivo, na sua própria infraestrutura.',
    cta: 'Agende uma demo ao vivo',
    hudLeft: 'Unicity · Comece Agora',
  },
});
