...
// Names, photos and hrefs stay outside the translation map; role + bio lines translate.
const founders = [
  {
    name: 'Mike Gault',
    photo: '/team/mike.jpg',
...
const T = tr({
  ...
  pt: {
    ...
    intro: (
      <>
        <span className="text-[#fefefe] font-bold">Unicity Labs.</span> PhDs em aprendizado de máquina e criptografia com quinze anos construindo infraestrutura de segurança de nível nacional para <span className="text-orange-400 font-bold">DARPA, NATO, Lockheed, Verizon e Maersk</span>. Agora aplicando isso aos trilhos sobre os quais seus agentes transacionam.
      </>
    ),
    ...
    founders: [
      ...
      },
      {
        ...
        lines: [
          'Visionário de IA',
          'CEO, Aleria (IA Soberana dos Emirados)',
          '1,000+ clientes · 250K agentes ativos',
        ],
      },
    ],
  },
