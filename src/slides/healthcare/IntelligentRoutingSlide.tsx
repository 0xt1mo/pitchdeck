...
// Stable numbering + selection flags stay language-independent.
const criteria = [{ n: '01' }, { n: '02' }, { n: '03' }, { n: '04' }];
const models = [{ selected: true }, { selected: false }, { selected: false }];

const T = tr({
  en: {
    eyebrow: 'Capability · Orchestrating the Agent Mesh',
    headLead: 'COST OPTIMIZATION:',
    headAccent: 'INTELLIGENT ROUTING.',
    intro: (
      <>
    ...
    criteriaNames: ['Complexity', 'Cost', 'Latency', 'Security clearance'],
    agentRequestTitle: 'AGENT REQUEST',
    agentRequestBody: 'Task, context, and required clearance presented to the routing layer.',
    routingDecisionTitle: 'ROUTING DECISION',
    models: [
      { name: 'HIGH-CAPABILITY MODEL', state: 'SELECTED', body: 'Complex reasoning, cleared context.' },
      { name: 'LIGHTWEIGHT MODEL', state: 'STANDBY', body: 'Low-cost path for simple tasks.' },
      { name: 'SPECIALIST CAPSULE', state: 'STANDBY', body: 'Sandboxed, clearance-scoped execution.' },
    ],
    properties: [
      {
  ...
  pt: {
    eyebrow: 'Capacidade · Orquestrando a Malha de Agentes',
    headLead: 'OTIMIZAÇÃO DE CUSTOS:',
    headAccent: 'ROTEAMENTO INTELIGENTE.',
    intro: (
      <>
        Cada requisição de agente é pontuada antes de ser executada e direcionada ao modelo certo — por complexidade da tarefa, custo, latência e autorização de segurança.{' '}
        <span className="text-[#fefefe]/65">A decisão de roteamento é, em si, um evento inspecionado e registrado, de modo que o tráfego é combinado à capacidade sem nunca escapar do limite de segurança.</span>
      </>
    ),
    criterionLabel: 'Critério',
    criteriaNames: ['Complexidade', 'Custo', 'Latência', 'Autorização de segurança'],
    agentRequestTitle: 'REQUISIÇÃO DE AGENTE',
    agentRequestBody: 'Tarefa, contexto e autorização necessária apresentados à camada de roteamento.',
    routingDecisionTitle: 'DECISÃO DE ROTEAMENTO',
    models: [
      { name: 'MODELO DE ALTA CAPACIDADE', state: 'SELECIONADO', body: 'Raciocínio complexo, contexto autorizado.' },
      { name: 'MODELO LEVE', state: 'EM ESPERA', body: 'Caminho de baixo custo para tarefas simples.' },
      { name: 'CÁPSULA ESPECIALISTA', state: 'EM ESPERA', body: 'Execução isolada em sandbox, limitada por autorização.' },
    ],
    properties: [
      {
        name: 'COMBINADO POR CAPACIDADE',
        body: 'Trabalho pesado chega a modelos potentes; trabalho trivial nunca paga por eles.',
      },
      {
        name: 'CIENTE DE AUTORIZAÇÃO',
        body: 'PHI só é roteado para um destino autorizado a lidar com PHI — nunca para um modelo que não seja.',
      },
      {
        name: 'REGISTRADO',
        body: 'A escolha de roteamento é um evento inspecionado — cada decisão é explicável posteriormente.',
      },
    ],
  },
});
