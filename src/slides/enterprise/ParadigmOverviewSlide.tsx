...
const T = tr({
  en: {
    ...
    headLead: 'THE L1 PARADIGM SHIFT:',
    headAccent: 'BEYOND SHARED LEDGERS',
    line1: (
      <>Satoshi's whitepaper was titled <span className="text-orange-400">"P2P electronic cash"</span></>
    ),
    line2: '17 years later we have neither P2P nor electronic cash',
    line3: 'Unicity finishes what Bitcoin started',
    traditionalTitle: 'Traditional Approach',
    traditionalAlt: 'Traditional blockchain approach',
    unicityTitle: 'Unicity Approach',
    unicityAlt: 'Unicity approach',
    bottom: (
  ...
  pt: {
    ...
    headLead: 'A MUDANÇA DE PARADIGMA L1:',
    headAccent: 'ALÉM DOS LEDGERS COMPARTILHADOS',
    line1: (
      <>O whitepaper de Satoshi se chamava <span className="text-orange-400">"P2P electronic cash"</span></>
    ),
    line2: '17 anos depois não temos nem P2P nem dinheiro eletrônico',
    line3: 'A Unicity termina o que o Bitcoin começou',
    traditionalTitle: 'Abordagem Tradicional',
    traditionalAlt: 'Abordagem tradicional de blockchain',
    unicityTitle: 'Abordagem Unicity',
    unicityAlt: 'Abordagem Unicity',
    bottom: (
      <>Todas as blockchains até hoje operam como ledgers compartilhados, levando à competição por recursos e a gargalos.
        A Unicity quebra esse paradigma — a primeira blockchain com transações verdadeiramente peer-to-peer,{' '}
        <span className="text-orange-400">eliminando o ledger compartilhado por completo</span>.
        Os ativos existem off-chain; a funcionalidade on-chain se reduz a impedir o gasto duplo.</>
    ),
  },
});
