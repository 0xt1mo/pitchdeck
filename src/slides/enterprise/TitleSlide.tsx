...
const T = tr({
  en: {
    headLead: 'INFRASTRUCTURE FOR THE',
    headAccent: 'AGENTIC ECONOMY',
    subtitle: 'Agent security, networking and trading at machine speed',
    enter: 'Enter',
  },
  pt: {
    headLead: 'INFRAESTRUTURA PARA A',
    headAccent: 'ECONOMIA AGÊNTICA',
    subtitle: 'Segurança, rede e negociação de agentes na velocidade da máquina',
    enter: 'Entrar',
  },
});
