...
const T = tr({
  en: {
    headThank: 'THANK',
    headYou: 'YOU',
    subtitle: 'Infrastructure for the agentic economy',
    placeholderKbbot: 'Ask about Unicity...',
    placeholderMike: 'Message Mike directly...',
    labelKbbot: 'Talk to our KnowledgeBot',
    labelMike: 'Talk to our CEO Agent to arrange a meeting',
  },
  pt: {
    headThank: 'MUITO',
    headYou: 'OBRIGADO',
    subtitle: 'Infraestrutura para a economia agêntica',
    placeholderKbbot: 'Pergunte sobre a Unicity...',
    placeholderMike: 'Envie uma mensagem direta ao Mike...',
    labelKbbot: 'Converse com nosso KnowledgeBot',
    labelMike: 'Converse com nosso Agente CEO para agendar uma reunião',
  },
});
      ...
      <div className="relative z-10 h-full flex flex-col px-6 sm:px-10 lg:px-16 py-6 sm:py-8">
        ...
        <div className="shrink-0 text-center">
          ...
          <motion.h1
            ...
            {T.headThank} <span className="text-orange-400">{T.headYou}</span>
          </motion.h1>
