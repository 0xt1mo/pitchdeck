...
const modules = [
  { color: '#f59e0b', id: 'skills' },
  { color: '#f97316', id: 'payments' },
  { color: '#ec4899', id: 'orchestration' },
  { color: '#a855f7', id: 'security' },
  { color: '#6366f1', id: 'networking' },
  { color: '#3b82f6', id: 'inference' },
];
...
// Highlight logic (which satellites/kernel light up per section) — non-text.
...
const T = tr({
  en: {
    ...
    labels: { kernel: 'KERNEL', security: 'SECURITY', payments: 'BLOCKCHAIN', token: 'TOKEN' } as Record<SectionId, string>,
    subtitles: {
      kernel: 'Architecture deep dive',
      security: 'Semantic Intercept Fabric',
      payments: 'The Unicity L1',
      token: 'Unicity Genesis Token',
  ...
  pt: {
    ...
    labels: { kernel: 'KERNEL', security: 'SEGURANÇA', payments: 'BLOCKCHAIN', token: 'TOKEN' } as Record<SectionId, string>,
    subtitles: {
      kernel: 'Aprofundamento na arquitetura',
      security: 'Semantic Intercept Fabric',
      payments: 'A Unicity L1',
      token: 'Token Genesis da Unicity',
    } as Record<SectionId, string>,
  },
});
