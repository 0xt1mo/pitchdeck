...
// Non-text data (names, photos, links) stays identical across languages.
const leaders = [
  { name: 'Mike Gault', photo: '/team/mike.jpg', linkedin: 'https://www.linkedin.com/in/mikegault1/' },
  { name: 'Vladimir Rogojin', photo: '/team/vladimir.png', linkedin: 'https://www.linkedin.com/in/vladimir-rogojin-369b7151/' },
  { name: 'Rajeev Gupta', photo: '/team/Nitish2.jpeg', linkedin: '' },
  { name: 'Tony Kenyon', photo: '/team/Tony.jpeg', linkedin: 'https://www.linkedin.com/in/tonykenyon/' },
  { name: 'Joshua J. Bouw', photo: '/team/joshua.jpeg', linkedin: 'https://www.linkedin.com/in/joshuajbouw/' },
  { name: 'Matt Law', photo: '/team/matt.jpg', linkedin: 'https://www.linkedin.com/in/mattlaw/' },
  { name: 'Pavel Grigorenko', photo: '/team/pavel.png', linkedin: 'https://www.linkedin.com/in/pavelgrigorenko/' },
  { name: 'Jamie Steiner', photo: '/team/jamie.jpg', linkedin: 'https://www.linkedin.com/in/jvsteiner/' },
];

// Roles and bio lines are display text (parallel to the leaders array by index).
const T = tr({
  en: {
    eyebrow: 'The People',
    title: 'MEET THE TEAM',
    subLine1: 'Experienced entrepreneurs with multiple exits',
    subLine2: 'PhDs in ML, Cryptography and Cybersecurity',
    cryptographyLabel: 'Cryptography',
    developmentLabel: 'Development',
    advisorsLabel: 'Advisors',
    leaderRoles: ['CEO', 'CTO', 'Commercial', 'Product', 'AI', 'Growth', 'Engineering', 'DeFi'],
    leaderLines: [
      ['PhD EE', 'Founder Guardtime (ADX:IHC)', 'MD Barclays Capital'],
      ['PhD CS', 'Somnium Metaverse, Guardtime'],
      ['CCO Etisalat'],
      ['PhD ML/Cybersecurity', 'Vitruvian, BT, Nokia, A10'],
      ['NEAR, Asimov, Blackcoin', 'Godfather Proof of Stake'],
      ['Outlier Ventures, Boson, Fetch.ai'],
      ['PhD CS', 'Microsoft, Guardtime'],
      ['JP Morgan, NEOM'],
    ],
    advisorFocus: ['Tokenization', 'AI', 'Stable-coin', 'Commerce'],
  },
  pt: {
    eyebrow: 'As Pessoas',
    title: 'CONHEÇA A EQUIPE',
    subLine1: 'Empreendedores experientes com múltiplas saídas',
    subLine2: 'PhDs em ML, Criptografia e Cibersegurança',
    cryptographyLabel: 'Criptografia',
    developmentLabel: 'Desenvolvimento',
    advisorsLabel: 'Conselheiros',
    leaderRoles: ['CEO', 'CTO', 'Comercial', 'Produto', 'IA', 'Crescimento', 'Engenharia', 'DeFi'],
    leaderLines: [
      ['PhD EE', 'Fundador da Guardtime (ADX:IHC)', 'MD Barclays Capital'],
      ['PhD CS', 'Somnium Metaverse, Guardtime'],
      ['CCO Etisalat'],
      ['PhD ML/Cibersegurança', 'Vitruvian, BT, Nokia, A10'],
      ['NEAR, Asimov, Blackcoin', 'Padrinho do Proof of Stake'],
      ['Outlier Ventures, Boson, Fetch.ai'],
      ['PhD CS', 'Microsoft, Guardtime'],
      ['JP Morgan, NEOM'],
    ],
    advisorFocus: ['Tokenização', 'IA', 'Stablecoin', 'Comércio'],
  },
});
              ...
              >
                ...
                <div>
                  ...
                  <p className="text-orange-400/70 text-[10px]" style={{ fontFamily: "'Geist Mono', monospace" }}>
                    CEO, {a.company} — {T.advisorFocus[i]}
                  </p>
                </div>
              </motion.a>
            ))}
