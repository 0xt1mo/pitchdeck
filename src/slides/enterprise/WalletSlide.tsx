...
const T = tr({
  en: {
    ...
    sendNow: (
      <>Send tokens to <span className="text-orange-400">@mike</span> right now →</>
    ),
    ...
    singleLine: 'A single line of code',
    anonymousWallet: 'Anonymous Wallet',
    ephemeralIdentity: 'Ephemeral identity',
    publicKey: 'Public Key',
    l1Address: 'L1 Address',
    directAddress: 'Direct Address',
    tokenBalances: 'Token Balances',
    noTokensYet: 'No tokens yet',
    noTokensHint: 'Send tokens to this wallet to see them here',
    pending: 'pending',
    sendToMike: 'Send to @mike',
    amountPlaceholder: 'Amount',
    send: 'Send',
    sentSuccess: 'Sent successfully!',
    noTokensToSend: 'No tokens available to send',
  },
  pt: {
    eyebrow: 'Demo ao Vivo',
    headLead: 'DINHEIRO ELETRÔNICO',
    headAccent: 'P2P VERDADEIRO',
    retry: 'Tentar novamente',
    intro: (
      <>Esta é uma <span className="text-orange-400">carteira real</span> rodando inteiramente no seu navegador.
        Sem extensões, sem sincronização de blockchain, sem criação de conta.</>
    ),
    bullets: [
      'Par de chaves efêmero gerado ao carregar a página',
      'Ativos armazenados localmente — sem ledger compartilhado',
      'Transferências privadas P2P via relays NOSTR',
    ],
    sendNow: (
      <>Envie tokens para <span className="text-orange-400">@mike</span> agora mesmo →</>
    ),
    implicationsLabel: 'Implicações',
    implications: [
      'Throughput ilimitado com o mesmo modelo de segurança do Bitcoin',
      'Validação na borda (o destinatário), não um conjunto de validadores',
      'Latência ultrabaixa',
      'Custo ultrabaixo: um microcentavo/tx',
    ],
    singleLine: 'Uma única linha de código',
    anonymousWallet: 'Carteira Anônima',
    ephemeralIdentity: 'Identidade efêmera',
    publicKey: 'Chave Pública',
    l1Address: 'Endereço L1',
    directAddress: 'Endereço Direto',
    tokenBalances: 'Saldos de Tokens',
    noTokensYet: 'Nenhum token ainda',
    noTokensHint: 'Envie tokens para esta carteira para vê-los aqui',
    pending: 'pendente',
    sendToMike: 'Enviar para @mike',
    amountPlaceholder: 'Quantia',
    send: 'Enviar',
    sentSuccess: 'Enviado com sucesso!',
    noTokensToSend: 'Nenhum token disponível para enviar',
  },
});
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}
              ...
              <div className="mt-4 space-y-2">
                ...
                <p className="text-[#fefefe]/70 text-xs sm:text-sm"
                  style={{ fontFamily: "'Geist Mono', monospace" }}>
                  <span className="text-orange-400 mr-2">→</span>{T.sendNow}
                </p>
              </div>
              <div className="mt-10 space-y-2">
                ...
                <p className="text-[#fefefe]/70 text-xs sm:text-sm leading-relaxed"
                  style={{ fontFamily: "'Geist Mono', monospace" }}>
                  <span className="text-orange-400 mr-2">→</span>{T.singleLine}
                </p>
                ...
                <div className="flex items-center gap-3 mb-3">
                  ...
                  <div>
                    <p className="text-orange-400 text-sm font-bold" style={{ fontFamily: "'Geist Mono', monospace" }}>
                      {identity?.nametag ? `@${identity.nametag}` : T.anonymousWallet}
                    </p>
                      ...
                      <div key={asset.symbol} className="rounded-lg px-3 py-2"
                        ...
                        {asset.unconfirmedAmount !== '0' && (
                          <p className="text-orange-400/60 text-[9px] mt-1" style={{ fontFamily: "'Geist Mono', monospace" }}>
                            {formatAmount(asset.unconfirmedAmount, asset.decimals)} {T.pending}
                          </p>
                        )}
                      </div>
                    ))}
