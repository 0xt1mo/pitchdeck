...
// Non-text data: `id` doubles as the stable nivo datum key + hover match key,
// so it stays English here; the display label comes from T.labels[id].
const slices = [
...
const T = tr({
  en: {
    eyebrow: 'Tokenomics',
    headLead: 'GENESIS',
    headAccent: 'TOKEN ALLOCATION',
    labels: {
      Ecosystem: 'Ecosystem',
      Investors: 'Investors',
      'Unicity Foundation': 'Unicity Foundation',
      'Founding Team': 'Founding Team',
      Liquidity: 'Liquidity',
      'Community Miners': 'Community Miners',
    } as Record<string, string>,
    tokensUnit: 'tokens',
    centerTotalSupply: 'TOTAL SUPPLY',
    totalGenesisLabel: 'Total Genesis Supply:',
    totalGenesisValue: '10,000,000,000 tokens',
  },
  pt: {
    eyebrow: 'Tokenomics',
    headLead: 'ALOCAÇÃO DE',
    headAccent: 'TOKENS GENESIS',
    labels: {
      Ecosystem: 'Ecossistema',
      Investors: 'Investidores',
      'Unicity Foundation': 'Unicity Foundation',
      'Founding Team': 'Time Fundador',
      Liquidity: 'Liquidez',
      'Community Miners': 'Mineradores da Comunidade',
    } as Record<string, string>,
    tokensUnit: 'tokens',
    centerTotalSupply: 'FORNECIMENTO TOTAL',
    totalGenesisLabel: 'Fornecimento Total Genesis:',
    totalGenesisValue: '10,000,000,000 tokens',
  },
});
        ...
        >
          <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
            ...
            <span style={{ color: '#fefefe', fontFamily: "'Anton', sans-serif", fontSize: 14, textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              {T.labels[datum.id as string] ?? datum.id}
            </span>
          </div>
          ...
          <div style={{ color: 'rgba(254,254,254,0.4)', fontSize: 10, marginTop: 2 }}>
            {((datum.value / 100) * 10_000_000_000).toLocaleString()} {T.tokensUnit}
          </div>
        </div>
      )}
      theme={{
          ...
          <div className="flex-1 space-y-3 sm:space-y-4">
            ...
            >
              <p className="text-[#fefefe]/40 text-[11px] sm:text-xs tracking-wider"
                style={{ fontFamily: "'Geist Mono', monospace" }}>
                {T.totalGenesisLabel}{' '}
                <span className="text-[#fefefe]/70">{T.totalGenesisValue}</span>
              </p>
            </motion.div>
          </div>
