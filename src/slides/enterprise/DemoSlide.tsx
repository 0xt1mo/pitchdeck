...
// Enterprise clusters — non-text layout data (names are display text, see T below).
const enterprises = [
  { color: '#3b82f6', cx: 0.19, cy: 0.22, r: 0.125 },
  { color: '#a855f7', cx: 0.81, cy: 0.20, r: 0.12 },
  { color: '#ec4899', cx: 0.17, cy: 0.78, r: 0.12 },
  { color: '#f59e0b', cx: 0.81, cy: 0.78, r: 0.125 },
  { color: '#10b981', cx: 0.5, cy: 0.5, r: 0.115 },
];
...
const T = tr({
  en: {
    ...
    enterpriseNames: ['Bank A', 'Logistics Co', 'Insurer', 'Bank B', 'Private Marketplace'],
    caption: (
  ...
  pt: {
    eyebrow: 'Produto',
    headLead: 'PRODUTO',
    headAccent: 'EMPRESARIAL',
    subtitle: (
      <>Implantações iniciais para <span className="text-orange-400">descoberta A2A</span>, <span className="text-orange-400">execução</span> e <span className="text-orange-400">liquidação</span> entre empresas</>
    ),
    enterpriseNames: ['Banco A', 'Empresa de Logística', 'Seguradora', 'Banco B', 'Marketplace Privado'],
    caption: (
      <>Demo de tokens USDT se movendo a <span className="text-orange-400">3M TPS</span>. Agente para Agente. Através da Internet.</>
    ),
  },
});
