...
const T = tr({
  en: {
    eyebrow: 'Appendix — Payments',
    headline: 'A2A MICROPAYMENTS',
    subHead: (
      <>
    ...
    humanFinance: <>HUMAN<br />FINANCE</>,
    machineFinance: <>MACHINE<br />FINANCE</>,
    sharedLedgerBlock: <>SHARED<br />LEDGER<br />BLOCKCHAINS</>,
    unicityTokenBlock: <>UNICITY<br />TOKEN<br />BLOCKCHAINS</>,
    vs: 'VS',
    humanTraits: [
      'Fragmentation by Necessity',
    ...
    machineTraits: [
      ...
      { label: 'Universal & Chain/Asset Agnostic', sub: undefined as string | undefined },
      { label: 'Unified Computational Substrate', sub: 'Web2 SDK · Any language, any runtime' },
    ],
  },
  pt: {
    eyebrow: 'Apêndice — Pagamentos',
    headline: 'MICROPAGAMENTOS A2A',
    subHead: (
      <>
        Cada token é, ele próprio, uma blockchain — autoautenticável com o{' '}
        <span className="text-orange-400">mesmo modelo de confiança do Bitcoin</span>.
        {' '}Sem ledger compartilhado. Apenas tokens verificáveis movendo-se P2P pela internet, em{' '}
        <span className="text-orange-400">escala massiva</span>
      </>
    ),
    humanFinance: <>FINANÇAS<br />HUMANAS</>,
    machineFinance: <>FINANÇAS DE<br />MÁQUINA</>,
    sharedLedgerBlock: <>BLOCKCHAINS<br />DE LEDGER<br />COMPARTILHADO</>,
    unicityTokenBlock: <>UNICITY<br />TOKEN<br />BLOCKCHAINS</>,
    vs: 'VS',
    humanTraits: [
      'Fragmentação por Necessidade',
      'Especialização Forçada',
      'Linguagens Complexas de Smart Contract',
    ],
    machineTraits: [
      { label: 'P2P Sem Atrito na Velocidade da Internet', sub: '10e-8 USD por TX · Throughput ilimitado' },
      { label: 'Universal e Agnóstico a Chain/Ativo', sub: undefined as string | undefined },
      { label: 'Substrato Computacional Unificado', sub: 'Web2 SDK · Qualquer linguagem, qualquer runtime' },
    ],
  },
});
