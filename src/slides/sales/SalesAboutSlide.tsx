...
const T = tr({
  en: {
    headLead: '15 YEARS OF',
    headAccent: 'CRYPTOGRAPHIC INFRASTRUCTURE.',
    caption: (
      <>
  ...
  pt: {
    headLead: '15 ANOS DE',
    headAccent: 'INFRAESTRUTURA CRIPTOGRÁFICA.',
    caption: (
      <>
        <span className="text-orange-400 font-bold">World Government Summit, Dubai.</span>{' '}
        Mike Gault recebendo o prêmio de Best Emerging Technology in Government das mãos de HH Sheikh Mohammed bin Rashid Al Maktoum.
      </>
    ),
    ...
    team: [
      ...
      { name: 'Alan Radi', role: 'Comercial', bio: 'Zain · Etisalat · Governo de Dubai' },
    ],
    proof: [
      { label: 'Fundou', value: 'Guardtime — DARPA, NATO, Lockheed, Ericsson, Maersk' },
      { label: 'Apoio VC', value: 'Blockchange Capital, Outlier Ventures' },
    ],
  },
});
            ...
            <div className="flex flex-col">
              {T.team.map((t, i) => (
                <motion.div
                  ...
                  className="py-4"
                  style={{
                    borderBottom: i < T.team.length - 1 ? '1px solid rgba(255,255,255,0.06)' : 'none',
                  }}
                >
                  <p
