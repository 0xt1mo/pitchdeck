...
const stats = [
  { value: '$400B+', color: 'rgba(245,158,11,0.9)' },
  { value: '88%', color: 'rgba(239,68,68,0.8)' },
  { value: '14%', color: 'rgba(239,68,68,0.55)' },
];
...
const T = tr({
  en: {
    headLead: 'AGENTIC AI IS HERE.',
    headAccent: 'EVERY GOVERNMENT, EVERY ENTERPRISE',
    statLabels: [
      'Agentic AI market by 2030',
      'of organisations reported AI agent security incidents',
      'of agents went live with security approval',
    ],
  },
  pt: {
    headLead: 'A IA AGÊNTICA CHEGOU.',
    headAccent: 'TODO GOVERNO, TODA EMPRESA',
    statLabels: [
      'Mercado de IA agêntica até 2030',
      'das organizações relataram incidentes de segurança com agentes de IA',
      'dos agentes entraram em produção com aprovação de segurança',
    ],
  },
});
