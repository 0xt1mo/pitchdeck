...
const T = tr({
  en: {
    headLead: 'THE BIGGEST BLOCKER TO PRODUCTION IS',
    headAccent: 'SECURITY.',
    subHead: (
      <>
    ...
    source: 'Source: Gartner 2026 — Primary Blockers to Agentic AI Production',
  },
  pt: {
    headLead: 'O MAIOR OBSTÁCULO À PRODUÇÃO É',
    headAccent: 'SEGURANÇA.',
    subHead: (
      <>
        A Gartner prevê que uma parcela enorme dos projetos de IA agêntica não chegará à produção até 2027.{' '}
    ...
    annotation: '← Isto é o que resolvemos',
    source: 'Fonte: Gartner 2026 — Principais Obstáculos à Produção de IA Agêntica',
  },
});
