...
const T = tr({
  en: {
    headLead: 'SEE IT',
    headAccent: 'IN ACTION.',
    bookDemo: 'Book a Live Demo',
    bookDemoBody: 'Move your agentic AI to production...',
    address: (
      <>
  ...
  pt: {
    ...
    bookDemoBody: 'Leve sua IA agêntica para produção...',
    address: (
      <>
        <span className="text-[#fefefe] font-bold">Unicity Labs</span>
        <br />
        502, 5º Andar, Al Montazah Tower B
        <br />
        Área de Khalidiyah, Abu Dhabi, EAU
      </>
    ),
  },
});
