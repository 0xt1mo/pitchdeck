...
export function MarketSlide() {
  return (
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      <div className="relative z-10 h-full flex flex-col justify-center gap-7 px-8 sm:px-12 lg:px-20 py-10 sm:py-14 lg:py-16">
        ...
        {/* ─── MIDDLE: Two columns ─── */}
        <div className="grid grid-cols-2 gap-10 lg:gap-14 mt-8">
