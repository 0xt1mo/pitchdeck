...
export function AgentsSmartContractsSlide() {
  return (
    <div className="fixed inset-0 z-50 bg-[#060606] overflow-hidden">
      ...
      <div className="relative z-10 h-full flex flex-col px-6 sm:px-10 lg:px-16 py-6 sm:py-8 justify-center gap-4">
        ...
        <div className="grid grid-cols-[1.2fr_1fr] gap-6 sm:gap-8 mt-5 items-start shrink-0">
